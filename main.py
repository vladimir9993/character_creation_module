...
class Character:
    ...
    def attack(self):
        """Считает нанесённый урон."""
        return (
            f'{self.name} нанёс урон противнику равный '
            f'{DEFAULT_ATTACK + randint(*self.RANGE_VALUE_ATTACK)}')

    def defence(self):
        """Считает заблокированный урон."""
        value_defence = DEFAULT_DEFENCE + randint(*self.RANGE_VALUE_DEFENCE)
        return (f'{self.name} блокировал {value_defence} ед. урона.')

    def special(self):
        """Отражает спецспособности."""
